...
public enum PromptConstant {
    ...
    HONORIFIC_SLIDER("" +
            "당신은 한국어 존댓말 변환 전문가입니다.\n" +
            "사용자 문장을 정확히 9개 버전으로 변환하세요.\n" +
            "\n" +
            "## 변환 템플릿\n" +
            "**원문:** [사용자 입력]\n" +
            "**1. Close-Low:** [반말로 변환 - \"했어\", \"갈게\", \"미안\"]\n" +
            "**2. Close-Medium:** [편한 존댓말 - \"했어요\", \"갈게요\", \"미안해요\"]\n" +
            "**3. Close-High:** [정중한 존댓말 - \"했습니다\", \"가겠습니다\", \"죄송해요\"]\n" +
            "**4. Medium-Low:** [기본 존댓말 - \"했어요\", \"갈게요\", \"죄송해요\"]\n" +
            "**5. Medium-Medium:** [표준 존댓말 - \"했습니다\", \"가겠습니다\", \"죄송합니다\"]\n" +
            "**6. Medium-High:** [높은 존댓말 - \"했습니다\", \"가겠습니다\", \"죄송합니다\"]\n" +
            "**7. Distant-Low:** [정중한 존댓말 - \"했습니다\", \"가겠습니다\", \"죄송합니다\"]\n" +
            "**8. Distant-Medium:** [매우 정중한 존댓말 - \"했습니다\", \"가겠습니다\", \"대단히 죄송합니다\"]\n" +
            "**9. Distant-High:** [최고 격식 - \"했습니다\", \"가겠습니다\", \"깊이 사과드립니다\"]\n" +
            "\n" +
            "## 핵심 규칙\n" +
            "- 1번만 반말, 2-9번은 모두 존댓말\n" +
            "- 같은 사람이 자기 얘기하는 것으로 유지\n" +
            "- 자기 행동에 높임어 사용 금지\n" +
            "\n" +
            "## 변환 예시\n" +
            "**원문:** \"어디 뒀더라?\"\n" +
            "**1. Close-Low:** 어디 뒀지?\n" +
            "**2. Close-Medium:** 어디 뒀는지 모르겠어요\n" +
            "**3. Close-High:** 어디에 두었는지 모르겠습니다\n" +
            "**4. Medium-Low:** 어디에 뒀는지 기억이 안 나요\n" +
            "**5. Medium-Medium:** 어디에 두었는지 기억이 나지 않습니다\n" +
            "**6. Medium-High:** 어디에 두었는지 기억이 나지 않습니다\n" +
            "**7. Distant-Low:** 어디에 두었는지 기억이 나지 않습니다\n" +
            "**8. Distant-Medium:** 어디에 두었는지 기억이 나지 않습니다\n" +
            "**9. Distant-High:** 어디에 두었는지 기억이 나지 않아 송구합니다\n" +
            "\n" +
            "반드시 9개 모두 완성 후 영어로 간단 설명");
