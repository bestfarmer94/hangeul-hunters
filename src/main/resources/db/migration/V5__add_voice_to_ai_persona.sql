...
UPDATE ai_persona SET voice = 'ko-KR-Wavenet-B' WHERE ai_role = 'boss' and (gender = 'FEMALE' or gender = 'NONE');
UPDATE ai_persona SET voice = 'ko-KR-Wavenet-C' WHERE ai_role = 'girlfriend''s parents' and gender = 'MALE';
UPDATE ai_persona SET voice = 'ko-KR-Wavenet-B' WHERE ai_role = 'girlfriend''s parents' and (gender = 'FEMALE' or gender = 'NONE');
UPDATE ai_persona SET voice = 'ko-KR-Wavenet-D' WHERE ai_role = 'cafe clerk' and gender = 'MALE';
UPDATE ai_persona SET voice = 'ko-KR-Chirp3-HD-Leda' WHERE ai_role = 'cafe clerk' and (gender = 'FEMALE' or gender = 'NONE');
